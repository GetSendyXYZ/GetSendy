...
export default function TransactionData({
  ...
  return (
    <motion.div
      layout="position"
      className={`relative cursor-move overflow-hidden grid grid-cols-1 backdrop-blur-[6px] justify-between items-start p-2 border-[1px] border-sendy border-opacity-25 bg-mutedOpacity bg-opacity-30 rounded-lg w-full z-10 mt-3 `}
